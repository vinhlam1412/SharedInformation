...
namespace HQSOFT.SharedInformation.Data;

public class SharedInformationTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<SharedInformationTenantDatabaseMigrationHandler> _logger;

    public SharedInformationTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<SharedInformationTenantDatabaseMigrationHandler> logger)
    {
