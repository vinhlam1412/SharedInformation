...
using HQSOFT.SharedInformation.Blazor.WebAssembly;
...
[DependsOn(
    ...
    typeof(SharedInformationBlazorWebAssemblyModule)
)]
public class SharedInformationBlazorHostModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(SharedInformationBlazorHostModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new SharedInformationHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("SharedInformation");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<SharedInformationBlazorHostModule>();
        });
    }
}
